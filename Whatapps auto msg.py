...
def msg():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            flash('Please enter a valid integer for the number of messages.', 'error')
    ...
    return render_template('auto_msg.html', title='Auto-Msg', sending_messages=sending_messages)
